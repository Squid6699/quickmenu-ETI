...
routerLogin.post("/login", async (req, res) => {
    ...
    const query = "SELECT u.id AS idUsername, u.username AS username, u.name AS name, u.roleId AS ROLE_ID, r.permissions AS ROL_PERMISSIONS FROM users U INNER JOIN role R ON U.roleId = R.id WHERE username = ? AND BINARY password = ?";
